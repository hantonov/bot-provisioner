...
class UserProfileDialog(ComponentDialog):
    def __init__(self, user_state: UserState):
        ...
        self.inital_dialog_id = WaterfallDialog.__name__
    ...
    async def name_confirm_step(self, step_context: WaterfallStepContext):
    ...
    async def age_step(self, step_context: WaterfallStepContext):
    ...
    async def summary_step(self, step_context: WaterfallStepContext):
        ...
        # end of waterfall dialog 
        return await step_context.end_dialog()

    @staticmethod
    async def age_prompt_validator(prompt_context: PromptValidatorContext):
